...
module.exports = class Card {
    ...
    */
    ...
    async toCard() {
        ...
        if(badges.bitfield !== 0) {
            ...
            for(let i = 0; i < badge.length; i++) {
                ...
                if(i === (badge.length - 1)) {
                    ...
                    if(this.user.displayAvatarURL({dynamic: true}).endsWith(".gif") || (member ? member.presence ? member.presence.activities[0] ? member.presence.activities[0].emoji !== null ? member.presence.activities[0].emoji.id !== undefined : "" : "" : "" : "") || (member ? member.premiumSinceTimestamp !== null : "") || this.bot.users.fetch(this.user.id, {force: true}).banner) {
                        if(this.guild.ownerId === this.user.id && member && member.premiumSinceTimestamp !== null) {
                        ...
                        } else if(this.guild.ownerId === this.user.id && member && member.premiumSinceTimestamp === null) {
                            const b = await Canvas.loadImage("https://cdn.discordapp.com/emojis/838059673700663316.png?v=1")
        ...
        const avatar = await Canvas.loadImage(member ? member.avatar ? member.avatarURL({format: 'png'}) : this.user.displayAvatarURL({format: 'png'}) : this.user.displayAvatarURL({format: 'png'}))
